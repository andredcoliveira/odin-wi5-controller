 ...
 */
public class OFStatisticsFuture extends OFMessageFuture<List<OFStatistics>> {

    protected volatile boolean finished;

    public OFStatisticsFuture(IThreadPoolService tp, IOFSwitch sw,
                              int transactionId) {
    ...
    public OFStatisticsFuture(IThreadPoolService tp, IOFSwitch sw,
                              int transactionId, long timeout,
                              TimeUnit unit) {
    ...
    @Override protected void handleReply(IOFSwitch sw, OFMessage msg) {
