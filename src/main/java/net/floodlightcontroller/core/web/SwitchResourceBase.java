...
public class SwitchResourceBase extends ServerResource {
    protected static Logger log = LoggerFactory
            .getLogger(SwitchResourceBase.class);
    ...
    protected List<OFStatistics> getSwitchStatistics(long switchId,
        ...
        if (sw != null) {
            ...
            if (statType == OFStatisticsType.FLOW) {
                ...
                specificReq
                        .setPortNumber((short) OFPort.OFPP_NONE.getValue());
                req.setStatistics(Collections.singletonList(
                        (OFStatistics) specificReq));
                requestLength += specificReq.getLength();
                ...
                specificReq
                        .setPortNumber((short) OFPort.OFPP_ALL.getValue());
            ...
            try {
                ...
                log.error("Failure retrieving statistics from switch {}", sw,
                          e);
            }
        }
        return values;
