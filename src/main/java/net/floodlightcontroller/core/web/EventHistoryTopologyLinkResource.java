...
public class EventHistoryTopologyLinkResource extends ServerResource {
    ...
    protected static Logger log = LoggerFactory
            .getLogger(EventHistoryTopologyLinkResource.class);
    ...
    public EventHistory<EventHistoryTopologyLink> handleEvHistReq() {
        ...
        try {
            LinkDiscoveryManager linkDiscoveryManager = (LinkDiscoveryManager) getContext()
                    .getAttributes().
                            get(ILinkDiscoveryService.class
                                        .getCanonicalName());
