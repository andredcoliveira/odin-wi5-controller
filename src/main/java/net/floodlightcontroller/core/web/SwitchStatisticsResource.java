...
public class SwitchStatisticsResource extends SwitchResourceBase {
    protected static Logger log = LoggerFactory
            .getLogger(SwitchStatisticsResource.class);
    ...
    @Get("json") public Map<String, Object> retrieve() {
        ...
        if (statType.equals("port")) {
            ...
            values = getSwitchStatistics(switchId,
                                         OFStatisticsType.AGGREGATE);
            ...
            IOFSwitch sw = floodlightProvider.getSwitches().get(HexString
                                                                        .toLong(switchId));
            if (sw != null) {
