...
public class FloodlightModuleContext implements IFloodlightModuleContext {
    ...
    public FloodlightModuleContext() {
        ...
        configParams = new HashMap<Class<? extends IFloodlightModule>, Map<String, String>>();
    }
    ...
    public <T extends IFloodlightService> T getServiceImpl(
            Class<T> service) {
    ...
    @Override public Collection<IFloodlightModule> getAllModules() {
        return moduleSet;
    }
     ...
     */
    @Override public Map<String, String> getConfigParams(
     ...
     */
    public void addConfigParam(IFloodlightModule mod, String key,
                               String value) {
