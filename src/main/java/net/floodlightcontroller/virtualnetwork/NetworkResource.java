...
public class NetworkResource extends ServerResource {
    protected static Logger log = LoggerFactory
            .getLogger(NetworkResource.class);
    ...
    protected void jsonToNetworkDefinition(String json,
    ...
    @Put @Post public String createNetwork(String postData) {
        ...
        if (network.gateway != null) {
            try {
                ...
                log.warn(
                        "Could not parse gateway {} as IP for network {}, setting as null",
    ...
    @Delete public String deleteNetwork() {
        IVirtualNetworkService vns = (IVirtualNetworkService) getContext()
                .getAttributes().
                        get(IVirtualNetworkService.class.getCanonicalName());
        String guid = (String) getRequestAttributes().get("network");
