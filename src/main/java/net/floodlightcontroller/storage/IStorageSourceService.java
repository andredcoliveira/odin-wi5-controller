...
public interface IStorageSourceService extends IFloodlightService {
     ...
     * @param values The map of column names/values to update the rows.
     */
    void updateMatchingRows(String tableName, IPredicate predicate,
     ...
     * @param values The map of column names/values to update the rows
     */
    void updateRow(String tableName, Object rowKey,
                   Map<String, Object> values);
     ...
     */
    public void addListener(String tableName,
     ...
     */
    public void removeListener(String tableName,
                               IStorageSourceListener listener);
