...
public class TypeMismatchStorageException extends StorageException {
    ...
    private static String makeExceptionMessage(String requestedType,
                                               String actualType,
                                               String columnName) {
        ...
        if (columnName == null)
            columnName = "???";
        String message = "The requested type (" + requestedType
                         + ") does not match the actual type (" + actualType
                         + ") of the value for column \"" + columnName
                         + "\".";
        return message;
    }
    ...
    public TypeMismatchStorageException(String requestedType,
                                        String actualType,
                                        String columnName) {
