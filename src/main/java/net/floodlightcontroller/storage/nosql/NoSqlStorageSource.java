...
public abstract class NoSqlStorageSource extends AbstractStorageSource {
    protected static Logger log = LoggerFactory
            .getLogger(NoSqlStorageSource.class);
    ...
    private Map<String, Map<String, ColumnIndexMode>> tableIndexedColumnMap = new HashMap<String, Map<String, ColumnIndexMode>>();
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" }) class NoSqlRangePredicate
            extends NoSqlPredicate {
        ...
        NoSqlRangePredicate(NoSqlStorageSource storageSource,
                            String tableName, String columnName,
                            Comparable<?> startValue, boolean startInclusive,
        ...
        public boolean incorporateComparison(String columnName,
            ...
            if (parentOperator == CompoundPredicate.Operator.AND) {
                switch (operator) {
                    ...
                    case LT:
                        if ((endValue == null) || (
                                ((Comparable) value).compareTo(endValue)
                                <= 0)) {
                            endValue = value;
                            endInclusive = false;
                            return true;
                    ...
                    case GT:
                        if ((startValue == null) || (
                                ((Comparable) value).compareTo(startValue)
                                >= 0)) {
                            startValue = value;
        ...
        private boolean isEqualityRange() {
            return (startValue == endValue) && startInclusive
                   && endInclusive;
        }

        public boolean canExecuteEfficiently() {
            ColumnIndexMode indexMode = storageSource
                    .getColumnIndexMode(tableName, columnName);
            switch (indexMode) {
                case NOT_INDEXED:
                    return false;
                case RANGE_INDEXED:
        ...
        public List<Map<String, Object>> execute(String columnNameList[]) {
            ...
            if (isEqualityRange())
                rowList = storageSource
                        .executeEqualityQuery(tableName, columnNameList,
                                              columnName, startValue);
            else
                rowList = storageSource
                        .executeRangeQuery(tableName, columnNameList,
                                           columnName, startValue,
                                           startInclusive, endValue,
                                           endInclusive);
        ...
        Comparable<?> coerceValue(Comparable<?> value, Class targetClass) {
            ...
            if (obj == null)
                throw new StorageException(
                        "Column value could not be coerced to the correct type");
    ...
    class NoSqlOperatorPredicate extends NoSqlPredicate {
        ...
        NoSqlOperatorPredicate(NoSqlStorageSource storageSource,
                               String columnName,
                               OperatorPredicate.Operator operator,
                               Object value) {
            this.storageSource = storageSource;
    ...
    class NoSqlCompoundPredicate extends NoSqlPredicate {
        ...
        NoSqlCompoundPredicate(NoSqlStorageSource storageSource,
                               CompoundPredicate.Operator operator,
                               boolean negated,
                               List<NoSqlPredicate> predicateList) {
            this.storageSource = storageSource;
        ...
        @SuppressWarnings({ "unchecked", "rawtypes" }) class RowComparator
        ...
        private List<Map<String, Object>> combineRowLists(
                String primaryKeyName, List<Map<String, Object>> list1,
            ...
            while (true) {
                ...
                update1 = (key2 == null) || (
                        ((Comparable) key1).compareTo(key2) <= 0);
                update2 = (key1 == null) || (
                        ((Comparable) key2).compareTo(key1) <= 0);
            }
        ...
        public List<Map<String, Object>> execute(String columnNames[]) {
            ...
            for (NoSqlPredicate predicate : predicateList) {
                List<Map<String, Object>> rowList = predicate
                        .execute(columnNames);
                if (combinedRowList != null) {
                    combinedRowList = combineRowLists("id", combinedRowList,
                                                      rowList, operator);
                } else {
    ...
    public void setTablePrimaryKeyName(String tableName,
    ...
    protected ColumnIndexMode getColumnIndexMode(String tableName,
                                                 String columnName) {
        ColumnIndexMode columnIndexMode = null;
        Map<String, ColumnIndexMode> indexedColumnMap = tableIndexedColumnMap
                .get(tableName);
    ...
    public void setColumnIndexMode(String tableName, String columnName,
                                   ColumnIndexMode indexMode) {
        Map<String, ColumnIndexMode> indexedColumnMap = tableIndexedColumnMap
                .get(tableName);
        if (indexedColumnMap == null) {
    ...
    Comparable<?> getOperatorPredicateValue(OperatorPredicate predicate,
        ...
        if (value instanceof String) {
            ...
            if ((stringValue.charAt(0) == '?') && (
                ...
                String parameterName = stringValue
    ...
    NoSqlPredicate convertPredicate(IPredicate predicate, String tableName,
                                    Map<String, Comparable<?>> parameterMap) {
        if (predicate == null)
            return null;
        ...
        if (predicate instanceof CompoundPredicate) {
            ...
            for (IPredicate childPredicate : compoundPredicate
                    .getPredicateList()) {
                ...
                if (childPredicate instanceof OperatorPredicate) {
                    ...
                    for (NoSqlPredicate childNoSqlPredicate : noSqlPredicateList) {
                        incorporated = childNoSqlPredicate
                                .incorporateComparison(childOperatorPredicate
                                                               .getColumnName(),
                                                       childOperatorPredicate
                                                               .getOperator(),
                                                       getOperatorPredicateValue(
                                                               childOperatorPredicate,
                                                               parameterMap),
                                                       compoundPredicate
                                                               .getOperator());
                ...
                if (!incorporated) {
                    NoSqlPredicate noSqlPredicate = convertPredicate(
                            childPredicate, tableName, parameterMap);
                    noSqlPredicateList.add(noSqlPredicate);
                }
            }
            convertedPredicate = new NoSqlCompoundPredicate(this,
                                                            compoundPredicate
                                                                    .getOperator(),
                                                            compoundPredicate
                                                                    .isNegated(),
            ...
            Comparable<?> value = getOperatorPredicateValue(
                    operatorPredicate, parameterMap);
            switch (operatorPredicate.getOperator()) {
                case EQ:
                    convertedPredicate = new NoSqlRangePredicate(this,
                                                                 tableName,
                                                                 operatorPredicate
                                                                         .getColumnName(),
                                                                 value, true,
                ...
                case GTE:
                    ...
                    break;
                default:
                    convertedPredicate = new NoSqlOperatorPredicate(this,
                                                                    operatorPredicate
                                                                            .getColumnName(),
                                                                    operatorPredicate
                                                                            .getOperator(),
            ...
            for (RowOrdering.Item item : rowOrdering.getItemList()) {
                ...
                if (result != 0) {
                    if (item.getDirection()
                        == RowOrdering.Direction.DESCENDING)
                        result = -result;
                    return result;
                }
            }
    ...
    private NoSqlResultSet executeParameterizedQuery(String tableName,
                                                     String[] columnNameList,
                                                     IPredicate predicate,
                                                     RowOrdering rowOrdering,
                                                     Map<String, Comparable<?>> parameterMap) {
        NoSqlPredicate noSqlPredicate = convertPredicate(predicate,
                                                         tableName,
                                                         parameterMap);
        List<Map<String, Object>> rowList;
        if ((noSqlPredicate != null) && noSqlPredicate
                .canExecuteEfficiently()) {
            rowList = noSqlPredicate.execute(columnNameList);
        } else {
            rowList = new ArrayList<Map<String, Object>>();
            Collection<Map<String, Object>> allRowList = getAllRows(
    ...
    public IQuery createQuery(String tableName, String[] columnNameList,
                              IPredicate predicate,
                              RowOrdering rowOrdering) {
        return new NoSqlQuery(tableName, columnNameList, predicate,
                              rowOrdering);
    }

    @Override public IResultSet executeQueryImpl(IQuery query) {
        NoSqlQuery noSqlQuery = (NoSqlQuery) query;
        return executeParameterizedQuery(noSqlQuery.getTableName(),
                                         noSqlQuery.getColumnNameList(),
                                         noSqlQuery.getPredicate(),
                                         noSqlQuery.getRowOrdering(),
                                         noSqlQuery.getParameterMap());
    }
    ...
    protected void sendNotification(String tableName,
        ...
        StorageSourceNotification notification = new StorageSourceNotification(
                tableName, action, rowKeys);
    ...
    protected void insertRowsAndNotify(String tableName,
                                       List<Map<String, Object>> insertRowList) {
        insertRows(tableName, insertRowList);
        sendNotification(tableName, StorageSourceNotification.Action.MODIFY,
                         insertRowList);
    }
    ...
    protected void updateRowsAndNotify(String tableName, Set<Object> rowKeys,
                                       Map<String, Object> updateRowList) {
        updateRows(tableName, rowKeys, updateRowList);
        sendNotification(tableName, StorageSourceNotification.Action.MODIFY,
                         rowKeys);
    }

    protected void updateRowsAndNotify(String tableName,
                                       List<Map<String, Object>> updateRowList) {
    ...
    @Override
    public void updateMatchingRowsImpl(String tableName,
                                       IPredicate predicate,
    ...
    @Override
    public void updateRowImpl(String tableName, Object rowKey,
                              Map<String, Object> values) {
        Map<String, Object> valuesWithKey = new HashMap<String, Object>(
                values);
        String primaryKeyName = getTablePrimaryKeyName(tableName);
    ...
    protected void deleteRowsAndNotify(String tableName,
                                       Set<Object> rowKeyList) {
        deleteRows(tableName, rowKeyList);
        sendNotification(tableName, StorageSourceNotification.Action.DELETE,
                         rowKeyList);
    }

    @Override public void deleteRowImpl(String tableName, Object key) {
        HashSet<Object> keys = new HashSet<Object>();
        keys.add(key);
        deleteRowsAndNotify(tableName, keys);
    }

    @Override public IResultSet getRowImpl(String tableName, Object rowKey) {
        List<Map<String, Object>> rowList = new ArrayList<Map<String, Object>>();
        Map<String, Object> row = getRow(tableName, null, rowKey);
        if (row != null)
            rowList.add(row);
        NoSqlResultSet resultSet = new NoSqlResultSet(this, tableName,
                                                      rowList);
        return resultSet;
    }
    ...
    protected abstract Collection<Map<String, Object>> getAllRows(
            String tableName, String[] columnNameList);

    protected abstract Map<String, Object> getRow(String tableName,
                                                  String[] columnNameList,
                                                  Object rowKey);

    protected abstract List<Map<String, Object>> executeEqualityQuery(
            String tableName, String[] columnNameList,
            String predicateColumnName, Comparable<?> value);

    protected abstract List<Map<String, Object>> executeRangeQuery(
            String tableName, String[] columnNameList,
            String predicateColumnName, Comparable<?> startValue,
            boolean startInclusive, Comparable<?> endValue,
            boolean endInclusive);

    protected abstract void insertRows(String tableName,
                                       List<Map<String, Object>> insertRowList);

    protected abstract void updateRows(String tableName, Set<Object> rowKeys,
