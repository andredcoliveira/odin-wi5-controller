...
public class NoSqlResultSet implements IResultSet {
    ...
    NoSqlResultSet(NoSqlStorageSource storageSource, String tableName,
                   List<Map<String, Object>> rowList) {
        this.storageSource = storageSource;
        this.primaryKeyName = storageSource
    ...
    @Override public Map<String, Object> getRow() {
    ...
    @Override public boolean getBoolean(String columnName) {
    ...
    @Override public byte getByte(String columnName) {
    ...
    @Override public byte[] getByteArray(String columnName) {
        byte[] b = null;
    ...
    @Override public double getDouble(String columnName) {
    ...
    @Override public float getFloat(String columnName) {
    ...
    @Override public int getInt(String columnName) {
    ...
    @Override public long getLong(String columnName) {
    ...
    @Override public short getShort(String columnName) {
    ...
    @Override public String getString(String columnName) {
        Object obj = getObject(columnName);
        if (obj == null)
            return null;
        return obj.toString();
    ...
    @Override public Date getDate(String column) {
        Date d;
        ...
        if (obj == null) {
            ...
            try {
                ...
                throw new TypeMismatchStorageException(Date.class.getName(),
                                                       obj.getClass()
                                                          .getName(),
                                                       column);
            }
    ...
    @Override public Short getShortObject(String columnName) {
        Short s;
        Object obj = getObject(columnName);
        if (obj instanceof Short) {
            ...
            try {
                ...
                throw new TypeMismatchStorageException(Short.class.getName(),
                                                       obj.getClass()
                                                          .getName(),
                                                       columnName);
            }
    ...
    @Override public Integer getIntegerObject(String columnName) {
        Integer i;
        Object obj = getObject(columnName);
        if (obj instanceof Integer) {
            ...
            try {
                ...
                throw new TypeMismatchStorageException(
                        Integer.class.getName(), obj.getClass().getName(),
                        columnName);
            }
        } else {
            i = null;
    ...
    @Override public Long getLongObject(String columnName) {
        Long l;
        Object obj = getObject(columnName);
        if (obj instanceof Long) {
            ...
            try {
                ...
                throw new TypeMismatchStorageException(Long.class.getName(),
                                                       obj.getClass()
                                                          .getName(),
                                                       columnName);
            }
    ...
    @Override public Float getFloatObject(String columnName) {
        Float f;
        Object obj = getObject(columnName);
        if (obj instanceof Float) {
            ...
            try {
                ...
                throw new TypeMismatchStorageException(Float.class.getName(),
                                                       obj.getClass()
                                                          .getName(),
                                                       columnName);
            }
    ...
    @Override public Double getDoubleObject(String columnName) {
        Double d;
        Object obj = getObject(columnName);
        if (obj instanceof Double) {
            ...
            try {
                ...
                throw new TypeMismatchStorageException(
                        Double.class.getName(), obj.getClass().getName(),
                        columnName);
            }
        } else {
            d = null;
    ...
    @Override public Boolean getBooleanObject(String columnName) {
        Boolean b;
        Object obj = getObject(columnName);
        if (obj instanceof Boolean) {
            ...
            try {
                ...
                throw new TypeMismatchStorageException(
                        Boolean.class.getName(), obj.getClass().getName(),
                        columnName);
            }
        } else {
            b = null;
    ...
    @Override public Byte getByteObject(String columnName) {
        Byte b;
        Object obj = getObject(columnName);
        if (obj instanceof Byte) {
            b = (Byte) obj;
            ...
            try {
                ...
                throw new TypeMismatchStorageException(Byte.class.getName(),
                                                       obj.getClass()
                                                          .getName(),
                                                       columnName);
            }
    ...
    @Override public boolean isNull(String columnName) {
        Object obj = getObject(columnName);
        return (obj == null);
    }
    ...
    @Override public void setBoolean(String columnName, boolean value) {
        addRowUpdate(columnName, value);
    }

    @Override public void setByte(String columnName, byte value) {
        addRowUpdate(columnName, value);
    }

    @Override public void setByteArray(String columnName, byte[] byteArray) {
    ...
    @Override public void setShort(String columnName, short value) {
        addRowUpdate(columnName, value);
    }
    ...
    @Override public void setShortObject(String columnName, Short value) {
        addRowUpdate(columnName, value);
    }
    ...
    @Override public void setLongObject(String columnName, Long value) {
        addRowUpdate(columnName, value);
    }

    @Override public void setFloatObject(String columnName, Float value) {
        addRowUpdate(columnName, value);
    }

    @Override public void setDoubleObject(String columnName, Double value) {
        addRowUpdate(columnName, value);
    }
    ...
    @Override public void setByteObject(String columnName, Byte value) {
        addRowUpdate(columnName, value);
    }

    @Override public void setDate(String column, Date value) {
    ...
    @Override public Iterator<IResultSet> iterator() {
