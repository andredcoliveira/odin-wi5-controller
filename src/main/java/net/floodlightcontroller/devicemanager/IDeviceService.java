...
public interface IDeviceService extends IFloodlightService {
     ...
     */
    public static final String CONTEXT_SRC_DEVICE = "net.floodlightcontroller.devicemanager.srcDevice";

    /**
     * The destination device for the current packet-in, if applicable.
     */
    public static final String CONTEXT_DST_DEVICE = "net.floodlightcontroller.devicemanager.dstDevice";
     ...
     */
    public static final FloodlightContextStore<IDevice> fcStore = new FloodlightContextStore<IDevice>();
