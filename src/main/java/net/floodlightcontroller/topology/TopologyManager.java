...
public class TopologyManager
    ...
    //
    @Override public Date getLastUpdateTime() {
        return lastUpdateTime;
    }

    @Override public void addListener(ITopologyListener listener) {
    ...
    @Override public long getL2DomainId(long switchId) {
    ...
    @Override public boolean isAllowed(long sw, short portId) {
    ...
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
    @Override public boolean isIncomingBroadcastAllowed(long sw,
                                                        short portId) {
     ...
     */
    @Override public Set<Short> getPorts(long sw) {
     ...
     * Get all the ports connected to the switch
     */
    @Override public Set<Short> getPorts(long sw, boolean tunnelEnabled) {
        TopologyInstance ti = getCurrentInstance(tunnelEnabled);
    ...
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
    @Override public NodePortTuple getOutgoingSwitchPort(long src,
                                                         short srcPort,
                                                         long dst,
                                                         short dstPort) {
    ...
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
    @Override public NodePortTuple getIncomingSwitchPort(long src,
                                                         short srcPort,
                                                         long dst,
                                                         short dstPort) {
     ...
     */
    @Override public boolean isInSameBroadcastDomain(long s1, short p1,
                                                     long s2, short p2) {
     ...
     */
    @Override public boolean isBroadcastDomainPort(long sw, short port) {
     ...
     */
    @Override public boolean isConsistent(long oldSw, short oldPort,
     ...
     */
    @Override public boolean inSameL2Domain(long switch1, long switch2) {
    ...
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
    @Override public NodePortTuple getAllowedOutgoingBroadcastPort(long src,
                                                                   short srcPort,
                                                                   long dst,
                                                                   short dstPort) {
        return getAllowedOutgoingBroadcastPort(src, srcPort, dst, dstPort,
                                               true);
    }
    ...
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
    @Override public NodePortTuple getAllowedIncomingBroadcastPort(long src,
                                                                   short srcPort) {
    ...
    @Override public Set<NodePortTuple> getBroadcastDomainPorts() {
        return portBroadcastDomainLinks.keySet();
    }

    @Override public Set<NodePortTuple> getTunnelPorts() {
        return tunnelLinks.keySet();
    }

    @Override public Set<NodePortTuple> getBlockedPorts() {
    ...
    @Override public Set<LDUpdate> getLastLinkUpdates() {
    ...
    @Override public Route getRoute(long src, long dst) {
    ...
    @Override public boolean routeExists(long src, long dst) {
    ...
    @Override public void roleChanged(Role oldRole, Role newRole) {
        switch (newRole) {
            ...
            case SLAVE:
                log.debug(
                        "Clearing topology due to " + "HA change to SLAVE");
    ...
    public static boolean isTunnelEnabled(FloodlightContext cntx) {
        if (cntx == null)
            return false;
        Boolean flag = (Boolean) cntx.getStorage()
                                     .get(CONTEXT_TUNNEL_ENABLED);
    ...
    public void doMultiActionPacketOut(byte[] packetData, IOFSwitch sw,
        ...
        // set action length
        po.setActionsLength(
                (short) (OFActionOutput.MINIMUM_LENGTH * ports.size()));
        ...
        short poLength = (short) (OFPacketOut.MINIMUM_LENGTH + po
        ...
        try {
            ...
            if (log.isTraceEnabled()) {
                log.trace("write broadcast packet on switch-id={} "
                          ...
                          new Object[] { sw.getId(), ports, packetData,
                                         po });
            }
            sw.write(po, cntx);
    ...
    protected void doFloodBDDP(long pinSwitch, OFPacketIn pi,
        ...
        if (switches
            == null) // this implies that there are no links connected to the switches
        {
    ...
    public void applyUpdates() {
        ...
        while (ldUpdates.peek() != null) {
            ...
            if (update.getOperation() == UpdateOperation.ADD_OR_UPDATE) {
                boolean added = (((update.getSrcPortState()
                                   & OFPortState.OFPPS_STP_MASK.getValue())
                                  != OFPortState.OFPPS_STP_BLOCK.getValue())
                                 && ((update.getDstPortState()
                                      & OFPortState.OFPPS_STP_MASK
                                              .getValue())
                                     != OFPortState.OFPPS_STP_BLOCK
                                             .getValue()));
                if (added) {
    ...
    public void createNewInstance() {
        ...
        TopologyInstance nt = new TopologyInstance(switchPorts, blockedPorts,
                                                   openflowLinks,
    ...
    private boolean addLinkToStructure(Map<NodePortTuple, Set<Link>> s,
                                       Link l) {
    ...
    public void removeLink(Link link) {
        ...
        if (switchPortLinks.get(srcNpt) == null) {
            if (switchPorts.get(srcNpt.getNodeId()) != null)
                switchPorts.get(srcNpt.getNodeId())
                           .remove(srcNpt.getPortId());
        }
        if (switchPortLinks.get(dstNpt) == null) {
            if (switchPorts.get(dstNpt.getNodeId()) != null)
                switchPorts.get(dstNpt.getNodeId())
                           .remove(dstNpt.getPortId());
        }

        // Remove the node if no ports are present
        if (switchPorts.get(srcNpt.getNodeId()) != null && switchPorts
                .get(srcNpt.getNodeId()).isEmpty()) {
            switchPorts.remove(srcNpt.getNodeId());
        }
        if (switchPorts.get(dstNpt.getNodeId()) != null && switchPorts
                .get(dstNpt.getNodeId()).isEmpty()) {
            switchPorts.remove(dstNpt.getNodeId());
        }
    }

    public void removeLink(long srcId, short srcPort, long dstId,
                           short dstPort) {
        Link link = new Link(srcId, srcPort, dstId, dstPort);
        removeLink(link);
    }
    ...
    @Override public boolean isTunnelEnabled(long srcMac, long dstMac) {
        return false;
    }
}
