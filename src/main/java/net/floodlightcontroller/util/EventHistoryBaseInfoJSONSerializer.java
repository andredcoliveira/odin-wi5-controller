...
public class EventHistoryBaseInfoJSONSerializer
        extends JsonSerializer<EventHistoryBaseInfo> {

    /**
     * Performs the serialization of a EventHistory.BaseInfo object
     */
    @Override public void serialize(EventHistoryBaseInfo base_info,
                                    JsonGenerator jGen,
        ...
        acStr = acStr.substring(0, 1).toUpperCase()
                     .concat(acStr.substring(1));
     ...
     */
    @Override public Class<EventHistoryBaseInfo> handledType() {
