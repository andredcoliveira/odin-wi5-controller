...
public class CountBuffer {
    ...
    public synchronized void increment(Date d, long delta) {
        ...
        Date endDate = new Date(
                startDate.getTime() + seriesLength * dsMillis - 1);
        ...
        if (d.getTime() < startDate.getTime()) {
            ...
            int index = (int) ((d.getTime() - startDate.getTime())
                               / dsMillis); // java rounds down on long/long
            ...
            int newBuckets =
                    (int) ((d.getTime() - endDate.getTime()) / dsMillis)
                    + 1; // java rounds down on long/long
            ...
            this.startDate = new Date(
                    startDate.getTime() + dsMillis * newBuckets);
            this.currentIndex =
                    (currentIndex + newBuckets) % this.seriesLength;
