...
public class SimpleCounter implements ICounter {
    ...
    @Override synchronized public void increment(Date d, long delta) {
        this.samplingTime = d;
     ...
     */
    @Override synchronized public CounterValue getCounterValue() {
        return this.counter;
    }
     ...
     */
    @Override synchronized public Date getCounterDate() {
     ...
     * Reset value.
     */
    @Override synchronized public void reset(Date startDate) {
