...
public class AgentRxStats extends ServerResource {
	...
	public Map<MACAddress, Map<String, String>> GetAgentScannedStationStats(String IpAddress){
		...
		try {
			...
			Map<MACAddress, Map<String, String>> res = oc.getRxStatsFromAgent(PoolManager.GLOBAL_POOL, InetAddress.getByName(apIpAddress));
