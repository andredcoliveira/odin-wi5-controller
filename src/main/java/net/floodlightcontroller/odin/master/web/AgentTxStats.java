...
public class AgentTxStats extends ServerResource {
	...
	public Map<MACAddress, Map<String, String>> GetAgentScannedStationStats(String IpAddress){
		...
		try {
			...
			Map<MACAddress, Map<String, String>> res = oc.getTxStatsFromAgent(PoolManager.GLOBAL_POOL, InetAddress.getByName(apIpAddress));
