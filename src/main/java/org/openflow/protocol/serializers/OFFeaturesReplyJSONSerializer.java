...
public class OFFeaturesReplyJSONSerializer
        extends JsonSerializer<OFFeaturesReply> {

    /**
     * Performs the serialization of a OFFeaturesReply object
     */
    @Override public void serialize(OFFeaturesReply reply,
                                    JsonGenerator jGen,
        ...
        jGen.writeStringField("datapathId",
                              HexString.toHexString(reply.getDatapathId()));
     ...
     */
    @Override public Class<OFFeaturesReply> handledType() {
