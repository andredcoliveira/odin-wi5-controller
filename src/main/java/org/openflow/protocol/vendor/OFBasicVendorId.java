...
public class OFBasicVendorId extends OFVendorId {
     ...
     * vendor id.
     */
    protected Map<Long, OFBasicVendorDataType> dataTypeMap = new HashMap<Long, OFBasicVendorDataType>();
    ...
    public OFBasicVendorId(int id, int dataTypeSize) {
        super(id);
        assert (dataTypeSize == 1) || (dataTypeSize == 2) || (dataTypeSize
                                                              == 4) || (
                       dataTypeSize == 8);
    ...
    public void registerVendorDataType(
            OFBasicVendorDataType vendorDataType) {
     ...
     */
    public OFVendorDataType parseVendorDataType(ChannelBuffer data,
                                                int length) {
